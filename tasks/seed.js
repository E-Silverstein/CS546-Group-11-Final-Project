...
import { userData, postData, commentData, reportData, keywordData } from "../data/index.js";
...
async function main() {
	...
	//reports
	const report = await reportData.createReport(post1._id,"Fashionista123","This outfit is ugly");
